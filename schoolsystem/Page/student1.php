    ...
    <div class="conter">
        ...
        <div class="conter_middle">
            <table cellspacing="0" cellpadding="0" class="sss">
                <tr>
                    <td class="bb">姓名:</td>
                    <td class="aa"><?php echo $qb[0];?></td>
                    <td class="bb">性别:</td>
                    <td class="aa"><?php echo $qb[1];?></td>
                </tr>
                <tr>
                    <td class="bb">出生日期:</td>
                    <td class="aa"><?php echo $qb[2];?></td>
                    <td class="bb">入学日期:</td>
                    <td class="aa"><?php echo $qb[3];?></td>
                </tr>
                <tr>
                    <td class="bb">学校名称:</td>
                    <td class="aa"><?php echo $qb[4];?></td>
                    <td class="bb">专业:</td>
                    <td class="aa"><?php echo $qb[5];?></td>
                </tr>
                <tr>
                    <td class="bb">学号:</td>
                    <td class="aa"><?php echo $cc;?></td>
                    <td class="bb">电话:</td>
                    <td class="aa"><?php echo $qb[6];?></td>
                </tr>
                <tr>
                    <td class="bb">宿舍:</td>
                    <td class="aa"><?php echo $qb[7];?></td>
                    <td class="bb">辅导员:</td>
                    <td class="aa"><?php echo $qb[8];?></td>
                </tr>
            </table>
        </div>
